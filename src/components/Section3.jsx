        ...
        <div className="flex flex-wrap -mx-3 items-center">
          ...
          <div className="w-full lg:w-1/2 px-3">
            <div>
              ...
              <div className="flex items-center gap-4 px-6 py-2 rounded-xl transition-all duration-200 hover:shadow-[0px_16px_24px_0px] hover:shadow-[#6061701F] hover:py-6">
                <div>
                  <svg
                    width="34"
                    height="34"
              ...
              <div className="flex items-center gap-4 px-6 py-2 rounded-xl transition-all duration-200 hover:shadow-[0px_16px_24px_0px] hover:shadow-[#6061701F] hover:py-6 my-6">
                <div>
                  <svg
                    width="40"
                    height="40"
